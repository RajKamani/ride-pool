...
@section('content')
    <div class="centered">
        <form class="form" method="POST" action="{{ route('register') }}">
            ...
            @enderror
            <input class="form__input" type="number" name="contact" placeholder="Contact" required />
            @error('contact')
            <span style="color: red;">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            @enderror
            <textarea name="address" class="form__input" placeholder="Address" required></textarea>
            @error('address')
            <span style="color: red;">
                    <strong>{{ $message }}</strong>
                </span>
